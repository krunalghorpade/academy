...
<!-- Mobile Bottom Bar -->
<div id="mobile-bottom-bar" class="md:hidden fixed bottom-0 left-0 w-full z-40 bg-black/95 backdrop-blur-md border-t border-white/10 px-4 py-3 pb-6 flex gap-3 transition-transform duration-300">
    <a href="#apply" class="flex-1 bg-white hover:bg-gray-200 text-black font-black uppercase tracking-widest text-sm flex justify-center items-center py-3.5 rounded-sm transition-colors">
        Apply Now
    </a>
    <a href="https://wa.me/placeholder" target="_blank" rel="noopener noreferrer" class="bg-[#25D366] text-white px-5 rounded-sm flex items-center justify-center shadow-[0_0_15px_rgba(37,211,102,0.2)]">
