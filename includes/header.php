<header id="main-header" class="fixed top-0 w-full z-50 transition-all duration-300 border-b bg-transparent border-transparent py-6">
    <div class="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
        <a href="/" class="flex items-center gap-3">
            <img src="images/kratex-logo.svg" alt="Kratex&trade;" class="h-6 md:h-8">
            <span class="text-xl md:text-2xl font-black tracking-tighter text-white uppercase pt-1">Academy</span>
        </a>
        ...
        <nav class="hidden md:flex items-center gap-8">
            ...
            <a href="#why-kratex" class="text-sm font-bold text-gray-300 hover:text-white transition-colors uppercase tracking-wider">Why Kratex<sup class="text-[0.55em]">&trade;</sup></a>
    ...
    <div id="mobile-menu" class="md:hidden absolute top-full left-0 w-full bg-black/95 backdrop-blur-xl flex flex-col items-center justify-center gap-8 overflow-hidden transition-all duration-300 h-0 opacity-0 py-0 border-b border-white/10">
        ...
        <a href="#why-kratex" class="mobile-link text-2xl font-bold text-gray-300 hover:text-white uppercase tracking-widest hidden">Why Kratex<sup class="text-[0.55em]">&trade;</sup></a>
