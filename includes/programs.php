    ...
    <div class="max-w-7xl mx-auto px-6 md:px-12">
        <div data-aos="fade-up" class="text-center mb-20 md:mb-24">
            ...
            <h2 class="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter">
                Choose Your <span class="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-600">Path</span>
            </h2>
        </div>
            ...
            <?php foreach($programs as $index => $program): ?>
                <div data-aos="fade-up" data-aos-delay="<?= $index * 150 ?>" 
                    ...
                    <?php if($program['popular']): ?>
                        <div class="absolute -top-4 left-1/2 -translate-x-1/2 bg-primary text-white text-xs font-black uppercase tracking-widest py-1.5 px-6 rounded-sm">
                            Most Popular
                        </div>
                    <?php endif; ?>
                    
                    <div class="mb-10">
                        <h3 class="text-3xl font-black text-white uppercase tracking-tighter mb-3"><?= $program['title'] ?></h3>
                        <div class="text-primary font-bold tracking-widest text-sm uppercase mb-5"><?= $program['duration'] ?></div>
                        ...
                        <ul class="flex flex-col gap-5 mb-12">
                            <?php foreach($program['features'] as $feat): ?>
                                <li class="flex items-center gap-4">
                                    <div class="w-1.5 h-1.5 rounded-full <?= $program['popular'] ? 'bg-primary' : 'bg-gray-500' ?>"></div>
